...
export default function Page(params: { id: number }) {
  ...
  useEffect(() => {
    if (retreivedUrl && url === undefined) {
      ...
      // WebViewer({
      //   path: '/chatbot/pdf', // point to where the files you copied are served from
      //   initialDoc: retreivedUrl // path to your document
  ...
  return (
    ...
    // <div style={{ overflow: 'auto', width: '100vw', height: '100vh', backgroundColor: 'darkgrey', padding: 5 }}>
    ...
    //             <button id="currentOutlineItem" className="toolbarButton" disabled title="Find Current Outline Item" tabIndex={6} data-l10n-id="pdfjs-current-outline-item-button">
    ...
    //             <input type="range" id="editorFreeTextFontSize" className="editorParamsSlider" value="10" min="5" max="100" step="1" tabIndex={101}/>
    //           </div>
    //         </div>
    //       </div>
    ...
    //             <input type="range" id="editorInkThickness" className="editorParamsSlider" value="1" min="1" max="20" step="1" tabIndex={103}/>
    //           </div>
    //           <div className="editorParamsSetter">
    //             <label htmlFor="editorInkOpacity" className="editorParamsLabel" data-l10n-id="pdfjs-editor-ink-opacity-input">Opacity</label>
    //             <input type="range" id="editorInkOpacity" className="editorParamsSlider" value="100" min="1" max="100" step="1" tabIndex={104}/>
    //           </div>
    //         </div>
    //       </div>
    ...
    //         <div className="editorParamsToolbarContainer">
    //           <button id="editorStampAddImage" className="secondaryToolbarButton" title="Add image" tabIndex={105} data-l10n-id="pdfjs-editor-stamp-add-image-button">
    ...
    //               <button id="viewFind" className="toolbarButton" title="Find in Document" tabIndex={12} data-l10n-id="pdfjs-findbar-button" aria-expanded="false" aria-controls="findbar">
    ...
    //                 <button id="editorFreeText" className="toolbarButton" disabled title="Text" role="radio" aria-checked="false" aria-controls="editorFreeTextParamsToolbar" tabIndex={31} data-l10n-id="pdfjs-editor-free-text-button">
    //                   <span data-l10n-id="pdfjs-editor-free-text-button-label">Text</span>
    //                 </button>
    //                 <button id="editorInk" className="toolbarButton" disabled title="Draw" role="radio" aria-checked="false" aria-controls="editorInkParamsToolbar" tabIndex={32} data-l10n-id="pdfjs-editor-ink-button">
    //                   <span data-l10n-id="pdfjs-editor-ink-button-label">Draw</span>
    //                 </button>
    //                 <button id="editorStamp" className="toolbarButton" disabled title="Add or edit images" role="radio" aria-checked="false" aria-controls="editorStampParamsToolbar" tabIndex={33} data-l10n-id="pdfjs-editor-stamp-button">
    ...
    //                   <option id="customScaleOption" title="" value="custom" disabled hidden data-l10n-id="pdfjs-page-scale-percent" data-l10n-args='{ "scale": 0 }'>0%</option>
